import scope from "../assets/slides/scope.png";
import medicines from "../assets/slides/medicines.png";
import nutrition from "../assets/slides/nutrition.png";
import institutional from "../assets/slides/institutional.jpg";
...
export const slides=[
 ...
 {image:surgical,label:"Business relationship",title:"Start the right conversation.",text:"Explore categories or send a commercial enquiry to our team."}
];
export const categories=["Drugs & Medicines","Laboratory Equipment","Orthopedic Soft Goods","Surgical Consumables","Hospital Equipment","Nutrition & IV Therapy"];
export const partners=[meril,tuberen,smith,abbott,healthium,aurolab,bbraun,merck,ti,cardinal,otsuka,bayer];
