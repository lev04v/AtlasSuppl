...
const ADDRESS = "WZ-819/A, 1st Floor, 14/2 Adil Bagh, Palam Metro Gate No. 01, Sabzi Mandi Road, Palam Manglapuri, New Delhi, Delhi 110045";
      ...
      <div className="container">
        <div className="section__head">
          ...
          <h2 id="map-section-title" className="section__title">
            Locate Wellness CureCare in New Delhi
          </h2>
        ...
        <div className="map-grid">
          <div className="map-frame">
            <iframe
              src={MAP_SRC}
              title="Wellness CureCare location on Google Maps"
              loading="lazy"
